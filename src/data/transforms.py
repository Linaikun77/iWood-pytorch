...
class RandomRotation(T.RandomRotation):
    def __init__(self, degrees, expand=False, center=None, fill=0, p=1.0):
        super().__init__(degrees, expand=expand, center=center, fill=fill)
        self.p = p
...
class RandomCLAHE(T.Transform):
    ...
    def __call__(self, *inputs: Any) -> Any:
        ...
        transformed = [apply_clahe(inpt) if isinstance(inpt, Image.Image) else inpt for inpt in inputs]
