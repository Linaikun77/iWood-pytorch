...
class BaseSolver(object):
    ...
    def train(self, ):
        ...
        # print("===cfg.train_dataloader:", self.cfg.train_dataloader)
        ...
        # print("===self.cfg.train_dataloader", self.cfg.train_dataloader)
        # print("===self.cfg.train_dataloader.dataset.transforms:", self.cfg.train_dataloader.dataset.transforms)
